...
var RequestService = /** @class */ (function () {
    ...
    RequestService.prototype.remove = function (url, options) {
        var _this = this;
        return axios_1.default
            .delete(url, __assign({}, options, { data: options && options.body ? options.body : null // This is workaround for setting "content-type": https://github.com/axios/axios/issues/86
         }))
            .catch(function (error) {
            return _this.handleError(error.response);
        });
