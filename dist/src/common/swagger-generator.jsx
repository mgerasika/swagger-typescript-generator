...
const swagger_1 = require("../../dist/dist-react-app/swagger");
const model_1 = require("../../dist/dist-react-app/swagger/model");
class SwaggerGenerator {
    ...
    generate() {
        ...
        {
            const html = server_1.renderToString(<swagger_1.ApiUrlsComponent classes={swaggerDoc.classes}/>);
            const text = swagger_1.html2text(html);
