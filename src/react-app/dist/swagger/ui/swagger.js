...
exports.Swagger = function (props) {
    ...
    var renderSwagger = function () {
        return root && root.definitions ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(api_classes_1.ApiClasses, { classes: root.classes }),
            react_1.default.createElement("hr", null),
            react_1.default.createElement(definitions_1.Definitions, { definitions: root.definitions }))) : null;
    };
